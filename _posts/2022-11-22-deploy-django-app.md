...
```
外网面板地址: http://123.57.135.55:38398/b2babfca
username: 3wbgr4az
password: fc015efb
```
...
项目路径（manage.py所在的目录）：/www/wwwroot/www.helloworld-yyds.top

用pip3 freeze > requirements.txt在项目路径生成requirements.txt

运行文件（wsgi.py文件的路径）：/www/wwwroot/www.helloworld-yyds.top/history01/wsgi.py
